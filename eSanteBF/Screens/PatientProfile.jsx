import {
  ...
  function PatientProfile(props) {
    ...
    async function getData() {
      ...
      console.log(token);
      axios
        .post('http://192.168.100.132:5001/userdata', {token: token})
        .then(res => {
    ...
    const handleBackPress = () => {
      Alert.alert('Quitter ', 'Etes vous sur de vouloir quitter?', [
        {
          text: 'Retour',
          onPress: () => null,
          style: 'cancel',
          ...
          <View style={{marginTop: 20, marginHorizontal: 25}}>
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>Genre</Text>
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>Telephone</Text>
