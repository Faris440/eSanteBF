...
function UpdateProfile() {
  ...
  const updateProfile = () => { 
    ...
    axios
      .post('http://192.168.100.132:5001/update-user', formdata)
    ...
    <ScrollView
      ...
      <View>
        <View style={styles.header}>
          ...
          <View style={{flex: 3}}>
            <Text style={styles.nameText}>Modifier le profile</Text>
          </View>
        ...
        <View
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Nom d'utilisateur</Text>
            <TextInput
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Genre</Text>

            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <View style={styles.radioView}>
                <Text style={styles.radioText}>Masculin</Text>
                <RadioButton
                  value="Male"
              ...
              <View style={styles.radioView}>
                <Text style={styles.radioText}>Feminin</Text>
                <RadioButton
                  value="Female"
          ...
          <View style={styles.infoEditView}>
            <Text style={styles.infoEditFirst_text}>Telephone</Text>
            <TextInput
        ...
        <View style={styles.button}>
          <TouchableOpacity
            ...
            style={styles.inBut}>
            <View>
              <Text style={styles.textSign}>Valider</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
